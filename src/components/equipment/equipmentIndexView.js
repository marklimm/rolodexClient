    ...
    render() {
        ...
        return (
            <div>
                ...
                <div>
                    this will display a list of equipment
                </div>
...
//}
//export default connect(null, mapDispatchToProps)(EquipmentIndex)


//  a shortcut in contrast to the above code for wiring up the fetchPosts action creator to this container
//export default connect(null, { fetchPosts: fetchPosts })(EquipmentIndex)
export default connect(mapStateToProps, { fetchPeople })(EquipmentIndex)
